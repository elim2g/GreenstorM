...
describe("Basic Search Test Suite", function() {	
	...
	it("Test that GenClr generates black when given a 0 index (edge case)", function() {
		var ind = 0;
		var testString = GenClr(ind);
		expect(testString).toEqual("#0");
	});
	
	it("Test that GenClr generates #fffff0 when given a 25 index (edge case)", function() {
		var ind = 25;
		var testString = GenClr(ind);
		expect(testString).toEqual("#fffff0");
	});
	
	it("Test that GenClr generates #7ae140 when given a 12 index", function() {
		var ind = 12;
		var testString = GenClr(ind);
